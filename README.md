...
├── 04_必須_Markdownとmdファイル入門.md
├── 05_必須_Cursorのモデルとエディタ.md
├── 06_必須_従来型エディタとCursorの比較.md
└── 07_推奨_作業空間とコンテキストの活用.md
```
→ テキストエディタの概念・プロジェクト・Markdown・モデルとエディタ・従来型エディタとCursorの比較・作業空間とコンテキストを学べる入門コンテンツ。

...
├── 01_必須_テキストエディタ入門.md
├── 02_必須_エディタの機能と限界.md
├── 03_必須_プロジェクトとフォルダ入門.md
├── 04_必須_Cursorのモデルとエディタ.md
├── 05_推奨_作業空間とコンテキストの活用.md
├── 06_必須_従来型エディタとCursorの比較.md
└── 07_推奨_Markdownとmdファイル入門.md
```
→ テキストエディタの概念・プロジェクト・モデルとエディタの違い・作業空間とコンテキスト・従来型エディタとCursorの比較・Markdownの書き方を学べる入門コンテンツ。

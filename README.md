...
#### 3. **Cursor入門** (`cursor-tutorial/` フォルダ)
```
cursor-tutorial/
├── README.md                    # 学習ガイド
├── 01_必須_テキストエディタとはなにか.md
├── 02_必須_できることとできないこと.md
├── 03_必須_プロジェクトとはなにか.md
├── 04_必須_Cursor入門_モデルとエディタの違い.md
├── 05_推奨_作業空間とコンテキスト.md
└── 06_必須_従来型のテキストエディタとCursorの違い.md
```
→ テキストエディタの概念・プロジェクト・モデルとエディタの違い・作業空間とコンテキスト・従来型エディタとCursorの違いを学べる入門コンテンツ。
...
### Phase 3: Cursor入門（推奨）
`cursor-tutorial/` のドキュメントでテキストエディタの概念・プロジェクト・モデルとエディタの違い・作業空間とコンテキストを学べます。

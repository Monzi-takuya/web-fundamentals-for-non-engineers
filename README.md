...
#### 0. **Cursor入門** (`cursor-tutorial/` フォルダ)
```
cursor-tutorial/
├── README.md                    # 学習ガイド
...
```
→ Cursorを使い始める前に、テキストエディタの概念・プロジェクト・モデルとエディタの違い・作業空間とコンテキストを学べる入門コンテンツ。
...
### Phase 0: Cursor入門（推奨）
Cursorを初めて使う場合は、まず `cursor-tutorial/` のドキュメントでテキストエディタの概念・プロジェクト・モデルとエディタの違い・作業空間とコンテキストを学んでください。
